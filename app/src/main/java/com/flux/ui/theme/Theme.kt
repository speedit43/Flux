    ...
    return when {
        dynamicColor -> {
            ...
            val base = when (contrast) {
                ...
                2 -> if (darkTheme) highContrastDarkColorScheme else highContrastLightColorScheme
...
fun FluxTheme(
    ...
    MaterialTheme(
        colorScheme = getColorScheme(darkTheme, data.dynamicTheme, amoledTheme, contrast),
